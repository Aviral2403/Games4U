...
const gameOver = (bool) => {
  if (bool) {
    ...
    gameover.classList.add("show");
    document.querySelector(".game").style.opacity = 0.8;
    gameoverimg.src = "hangmanimgages/victory.gif";
...
const loadQuestion = () => {
  ...
  buttonTag.forEach((v) => {
    v.addEventListener("click", (e) => {
      ...
      if (count >= 1 && count < 2) {
        img.src = "hangmanimgages/hangman-1.svg";
      } else if (count >= 2 && count < 3) {
        img.src = "hangmanimgages/hangman-2.svg";
      } else if (count >= 3 && count < 4) {
        img.src = "hangmanimgages/hangman-4.svg";
      } else if (count >= 4 && count < 5) {
        img.src = "hangmanimgages/hangman-5.svg";
      } else if (count >= 6 && count < 7) {
        img.src = "hangmanimgages/hangman-6.svg";
        setTimeout(()=>{
          gameOver(true);
        },200)
